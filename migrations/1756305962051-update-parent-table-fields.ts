...
export class UpdateParentTableFields1756305962051 implements MigrationInterface {
    name = 'UpdateParentTableFields1756305962051'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "parent" DROP COLUMN "conversationState"`);
        await queryRunner.query(`ALTER TABLE "parent" DROP COLUMN "lastMessage"`);
        await queryRunner.query(`ALTER TABLE "parent" DROP COLUMN "lastChosenOption"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "parent" ADD "lastChosenOption" character varying`);
        await queryRunner.query(`ALTER TABLE "parent" ADD "lastMessage" character varying`);
